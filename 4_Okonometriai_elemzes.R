#ebben a dokumentumban a szentimentelemzésem idõsorait vizsgálom
...
#1. MÓDSZER: legjobb arima modell a teljes idõsoron
...
#2. MÓDSZER: a legjobb elõrejelzõ modell
...
#legjobb elõrejelzõ modell keresése
...
#3. ÖSSZEHASONLÍTÁS: Diebold-Mariano teszt a két különbözõ eljárás esetén kapott modellek 
#hibáinak különbözõségének becslésére
